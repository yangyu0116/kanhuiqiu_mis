...
$this->menu=array(
    ...
    array('label'=>'重新处理视频图片', 'url'=>array('updateFlag', 'id'=>$model->video_id)),
...
<h1>短视频 #<?php echo $model->video_id; ?> <?php echo $model->video_title; ?></h1>
...
$this->widget('zii.widgets.grid.CGridView', array(
    ...
    'dataProvider' => $tokenize->searchByVideoId($model->video_id),
    'ajaxUpdate' => false,
    'columns' => array(
        array(
            'name' => 'video_id',
